...
![Image_of_Queue_Structure](images/queue_image.png)
...
```
Here is the link to the full solution: [Solution](solutions/rainbow_of_color_solution.py)
...
[Solution](solutions/counting_down_solution.py)
